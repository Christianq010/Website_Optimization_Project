...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
    ...
    // Returns the size difference to change the size of a pizza element
    function changePizzaSizes(size) {
      var newWidth;
        ...
        var pizLength = pizzaContainer.length;
    // Iterates and changes the pizza elements width
            for (var i = 0; i < pizLength; i++){
                pizzaContainer[0].style.width = newWidth + "%";
            }
        }
